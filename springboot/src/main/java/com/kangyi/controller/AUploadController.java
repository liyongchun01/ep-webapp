...
//
                 ...
                 System.out.println("  @#$11 String 实体: "+yiMiao1);
             ...
             if (data.get( "jingdu"  )!=null ||data.get( "weidu"  )!=null ) {
                 ...
                 System.out.println("  @#$11 String st: "+st);
                 System.out.println("  @#$11 String 实体: "+geLi1);
...
//             System.out.println("@#$44 data: "+data.toString());
//             System.out.println("@#$44 data.get(guiji ): "+data.get( "guiji" ));
...
//            @RequestParam(value = "typeId",defaultValue = "") Long typeId,
//            @RequestParam(value = "type",defaultValue = "") int type
            //            @RequestParam(value ="GuiJi[]")List<GuiJi> listGuiJi,
//            @RequestBody List<GuiJi> listGuiJi,
//             List<GuiJi> listGuiJi,
//            HeSuan heSuan ,
//             YiMiao yiMiao,
//             GuiJi guiJi,
//            GeLi geLi
...
//
//            ArrayList<GuiJi> listGuiJi = new ArrayList<GuiJi>();
